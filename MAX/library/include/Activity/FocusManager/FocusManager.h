...
public:
    ...
    FocusManager(
        ...
        std::shared_ptr<InterruptModel> interruptModel = nullptr);
    ...
    void modifyContentType(const std::string& channelName, const std::string& interfaceName, ContentType contentType)
        override;
...
private:
     ...
     */
    MixingBehavior getMixingBehavior(std::shared_ptr<Channel> lowPrioChannel, std::shared_ptr<Channel> highPrioChannel);

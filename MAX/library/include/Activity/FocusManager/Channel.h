...
private:
     ...
     */
    void patienceTimerCallback(std::shared_ptr<FocusManagerInterface::Activity> activity);
...
private:
    ...
    utils::timing::Timer m_patienceTimer;

    /// Activity to track the initiator of patience.
    std::shared_ptr<FocusManagerInterface::Activity> m_patienceInitiator;

    /// Activity to track the receiver of patience.
    std::shared_ptr<FocusManagerInterface::Activity> m_patienceReceiver;
};

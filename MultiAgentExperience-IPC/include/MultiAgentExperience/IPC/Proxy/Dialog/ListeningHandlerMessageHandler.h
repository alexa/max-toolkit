...
#ifndef MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_LISTENINGHANDLERMESSAGEHANDLER_H
#define MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_LISTENINGHANDLERMESSAGEHANDLER_H
...
class ListeningHandlerMessageHandler : public transport::MessageHandler {

public:
    ListeningHandlerMessageHandler(
    ...
    /**
     * Responsible for handling the requests sent by the @c ListeningHandlerProxy. Invokes the respective
     * @c ListeningHandlerInterface::onStartListening method.
     *
    ...
    /**
     * Responsible for handling the requests sent by the @c ListeningHandlerProxy. Invokes the respective
     * @c ListeningHandlerInterface::onStopListening method.
     *
...
private:
    ...
    std::shared_ptr<multiAgentExperience::dialog::ListeningHandlerInterface> m_handler;
};
...
#endif //MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_LISTENINGHANDLERMESSAGEHANDLER_H

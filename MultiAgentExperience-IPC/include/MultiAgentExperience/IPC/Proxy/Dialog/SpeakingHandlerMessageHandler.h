...
#ifndef MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_SPEAKINGHANDLERMESSAGEHANDLER_H
#define MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_SPEAKINGHANDLERMESSAGEHANDLER_H
...
class SpeakingHandlerMessageHandler : public transport::MessageHandler {

public:
    SpeakingHandlerMessageHandler(
    ...
    /**
     * Responsible for handling the requests sent by the @c SpeakingHandlerProxy. Invokes the respective
     * @c SpeakingHandlerInterface::onStartSpeaking method.
     *
    ...
    /**
     * Responsible for handling the requests sent by the @c SpeakingHandlerProxy. Invokes the respective
     * @c SpeakingHandlerInterface::onStopSpeaking method.
     *
...
private:
    ...
    std::shared_ptr<multiAgentExperience::dialog::SpeakingHandlerInterface> m_handler;
};
...
#endif //MULTIAGENTEXPERIENCE_IPC_PROXY_DIALOG_SPEAKINGHANDLERMESSAGEHANDLER_H

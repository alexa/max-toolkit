...
#ifndef MULTI_AGENT_EXPERIENCE_LIBRARY_INCLUDE_UTILS_THREADING_EXECUTOR_H_
#define MULTI_AGENT_EXPERIENCE_LIBRARY_INCLUDE_UTILS_THREADING_EXECUTOR_H_
...
public:
     ...
     */
    Executor(bool async = true, const std::chrono::milliseconds& delayExit = std::chrono::milliseconds(1000));
...
private:
    ...
    utils::threading::TaskThread m_taskThread;
};
...
#endif  // MULTI_AGENT_EXPERIENCE_LIBRARY_INCLUDE_UTILS_THREADING_EXECUTOR_H_
